...
<head>
    ...
    <link rel="stylesheet" href="css/productos-ventilacion.css">
    ...
    <title>Magiclick | Ventilación</title>
</head>
    ...
    <main>
        <section>
            <div class="quienes-somos">
                ...
                <img src="imagenes/banner_cat_venti_04.jpg" alt="">
                <div class="text-somos">
                    <h2 id="video-toggle">VENTILACIÓN</h2>
                </div>
            </div>
        </section>
        <section id="buscar">
...
<%
    ...
    ResultSet rs = st.executeQuery("SELECT * FROM `productosventilacion` WHERE 1");
    ...
    while (rs.next()) {
        ...
        <% } %>
                ...
                <div class="descripcion">
                    <ul>
    <li class="hidden"><%= caracteristica1 %></li>
    <li class="hidden"><%= caracteristica2 %></li>
    <li class="hidden"><%= caracteristica3 %></li>
    <li class="hidden"><%= caracteristica4 %></li>
...
<a href="/catalogo-bazar.pdf"><button><i class="fa-regular fa-file-pdf"> CATÁLOGO</i></button></a>
    <a href="imagenes/productos-calefaccion/<%= manualPDF %>" download><button><i class="fa-regular fa-file-pdf"> MANUAL</i></button></a>
</div>
...
%>
    ...
    <script src="js/productos-ventilacion.js"></script>
</body>
