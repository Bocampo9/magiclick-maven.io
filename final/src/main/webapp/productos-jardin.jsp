...
<head>
    ...
    <link rel="stylesheet" href="css/productos-jardin.css">
    ...
    <main>
        <section>
            <div class="quienes-somos">
                ...
                <img src="imagenes/banner_cat_jardin_04.jpg" alt="">
                <div class="text-somos">
                    <h2 id="video-toggle">JARDÍN</h2>
                </div>
            </div>
        </section>
        <section id="buscar">
...
<%
    ...
    ResultSet rs = st.executeQuery("SELECT * FROM `productosjardin` WHERE 1	");
    ...
    while (rs.next()) {
        ...
        String caracteristica6= rs.getString("carasteristica6");
    ...
    <li class="hidden"><%= caracteristica6 %></li>
                    </ul>
<div class="catalogo">
